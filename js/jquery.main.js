jQuery(function() {
    ...
    $.getJSON(urlData, function(response) {
        ...
        $.each(questions, function(i, item) {
            ...
            content += '<div class="question-section card mb-5" id="question' + counter + '">'
            ...
            + '<h2>' + question + '</h2>'
            + '<ul class="list-group">';
            content += ansA?'<li class="list-group-item ' + (correctAns=='A'?'correct':'wrong') + '">1: <span class="answer">' + ansA + '</span></li>':'';
            content += ansB?'<li class="list-group-item ' + (correctAns=='B'?'correct':'wrong') + '">2: <span class="answer">' + ansB + '</span></li>':'';
            content += ansC?'<li class="list-group-item ' + (correctAns=='C'?'correct':'wrong') + '">3: <span class="answer">' + ansC + '</span></li>':'';
            content += ansD?'<li class="list-group-item ' + (correctAns=='D'?'correct':'wrong') + '">4: <span class="answer">' + ansD + '</span></li>':'';
            content +='</ul></div></div>';
